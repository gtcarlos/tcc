...
class InvestorsControllerTest < ActionController::TestCase
  ...
  test "should create investor" do
    assert_difference('Investor.count') do
      post :create, investor: { area: @investor.area, bio: @investor.bio, company: @investor.company, history: @investor.history, location: @investor.location, name: @investor.name }
    end
  ...
  test "should update investor" do
    put :update, id: @investor, investor: { area: @investor.area, bio: @investor.bio, company: @investor.company, history: @investor.history, location: @investor.location, name: @investor.name }
    assert_redirected_to investor_path(assigns(:investor))
  end
