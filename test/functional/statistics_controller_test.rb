...
class StatisticsControllerTest < ActionController::TestCase
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post :create, statistic: { hits: @statistic.hits, post_shared: @statistic.post_shared, post_views: @statistic.post_views, published_posts: @statistic.published_posts }
    end
  ...
  test "should update statistic" do
    put :update, id: @statistic, statistic: { hits: @statistic.hits, post_shared: @statistic.post_shared, post_views: @statistic.post_views, published_posts: @statistic.published_posts }
    assert_redirected_to statistic_path(assigns(:statistic))
  end
