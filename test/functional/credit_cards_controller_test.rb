...
class CreditCardsControllerTest < ActionController::TestCase
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post :create, credit_card: { date: @credit_card.date, flag: @credit_card.flag, name: @credit_card.name, number: @credit_card.number, seg_cod: @credit_card.seg_cod }
    end
  ...
  test "should update credit_card" do
    put :update, id: @credit_card, credit_card: { date: @credit_card.date, flag: @credit_card.flag, name: @credit_card.name, number: @credit_card.number, seg_cod: @credit_card.seg_cod }
    assert_redirected_to credit_card_path(assigns(:credit_card))
  end
